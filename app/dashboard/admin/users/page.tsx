...
import { downloadUsersExcel } from "./DownloadUsers";
...
export default function Page() {
    ...
    const handleChangePassword = async (id: string, password: string) => {
      ...
      const handleDownloadExcel = async () => {
        const confirmed = await ConfirmModal("Download Users to Excel?", {
          okText: "Yes, Download",
          cancelText: "Cancel",
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-x-6 bg-white p-4 rounded-lg shadow-sm border border-gray-100">
        ...
        <div className="flex gap-2">
          <ButtonGuardWrapper requiredRoles={["ADMINISTRATOR", "USERS_CANDOWNLOADUSERS"]}>
            <button
          ...
          <ButtonGuardWrapper requiredRoles={["ADMINISTRATOR", "USERS_CANPRINTUSERS"]}>
            <DownloadUsersPdf users={filteredUsers} searchQuery={searchQuery} />
          </ButtonGuardWrapper>
                  ...
                  <td className="sticky right-0 z-10 bg-white px-6 py-2 text-sm space-x-2 whitespace-nowrap shadow-[-2px_0_5px_-2px_rgba(0,0,0,0.1)]">
                    ...
                    <ButtonGuardWrapper requiredRoles={['ADMINISTRATOR','USERS_CANASSIGNUSERSROLES']}>
                        <button 
                            ...
                            className="rounded bg-teal-600 px-3 py-1 font-semibold text-white hover:bg-teal-700"
                            title="Assign Roles"
                        >
                            Roles
                        </button>
